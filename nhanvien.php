            ...
            <header style="background:#f2f4d7" class="p-2 d-flex">
                ...
                <a class=" d-inline col ms-5" href="addEmployee_nhanvien.php">
                    <button type="button" class="btn btn-primary d-flex" data-toggle="modal"
                        ...
                        <div class="">
                            <p class="d-inline">Tạo nhân viên</p>
                        </div>
                    </button>
                </a>
                ...
                <div class="container m-5">
                    ...
                    ?>
                            <tr>
                                ...
                                <td><a href="update_employee_nhanvien.php?id=<?php echo $row['MaNV']; ?>"><i
                                            class="bi bi-pencil-square"></i></a></td>
                                <td><a href="delete_employee_nhanvien.php?id=<?php echo $row['MaNV']; ?>"><i
                                            class="bi bi-trash"></i></a></td>
                                <td><a href="detail_nhanvien.php?id=<?php echo $row['MaNV']; ?>">Chi tiết</a></td>
                            </tr>
                            <?php
                        }
                    }
