    ...
    <main>
        ...
        <div class="content" style="width: 84%;height:1000px">
            <header style="background:#f2f4d7" class="p-2 d-flex">
                <h5 class="ms-5 mt-1 fw-bold d-inline col" style="color:#307ecc">Thêm mới khách hàng</h5>
            </header>
            <main class="">
                <div class="container" style="margin:130px 200px 0px 150px">
                    <form action="process-add-employee.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="txtSđt" name="txtSđt"
                                placeholder="Nhập số máy bàn">
                        </div>
