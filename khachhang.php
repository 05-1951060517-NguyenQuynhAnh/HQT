        ...
        <div class="content" style="width: 84%;height:1000px">
            ...
            <main>
                ...
                <div class="container m-5">
                    ...
                    ?>
                            <tr>
                                <th scope="row"><?php echo $row['MaK']; ?></th>
                                <td><?php echo $row['Hoten']; ?></td>
                                <td><?php echo $row['Diachi']; ?></td>
                                <td><?php echo $row['Sđt']; ?></td>

                                <td><a href="update_employee.php?id=<?php echo $row['MaK']; ?>"><i
                                            class="bi bi-pencil-square"></i></a></td>
                                <td><a href="delete_employee.php?id=<?php echo $row['MaK']; ?>"><i
                                            class="bi bi-trash"></i></a></td>
                                <td><a href="detail.php?id=<?php echo $row['MaK']; ?>">Chi tiết</a></td>
                            </tr>
                            <?php
                        }
                    }
