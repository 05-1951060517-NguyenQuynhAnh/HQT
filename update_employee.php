    ...
    <main>
        ...
        <div class="content" style="width: 84%;height:1000px">
            <header style="background:#f2f4d7" class="p-2 d-flex">
                <h5 class="ms-5 mt-1 fw-bold d-inline col" style="color:#307ecc">Cập nhật thông tin khách hàng</h5>
            </header>
            <main class="">
            <div class="container" style="margin:130px 200px 0px 150px">
            <form action="process-update-employee.php" method="post">
                <div class="form-group">
                    <label for="txtMaK">Mã khách hàng</label>
                    <input type="text" class="form-control" id="txtMaK" name="txtMaK" 
                        placeholder="Nhập mã khách hàng" value="<?php echo $row['MaK'];?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="txtSđt">Số điện thoại</label>
                    <input type="tel" class="form-control" id="txtSđt" name="txtSđt" placeholder="Nhập số điện thoại"
