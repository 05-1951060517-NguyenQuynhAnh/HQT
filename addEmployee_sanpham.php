    ...
    <main>
        ...
        <div class="content" style="width: 84%;height:1000px">
            <header style="background:#f2f4d7" class="p-2 d-flex">
                <h5 class="ms-5 mt-1 fw-bold d-inline col" style="color:#307ecc">Thêm mới sản phẩm</h5>
            </header>
            <main class="">
                <div class="container" style="margin:130px 200px 0px 150px">
                    <form action="process-add-employee_sanpham.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txtHoten" name="txtTenSP"
                                placeholder="Nhập tên sản phẩm">
                        </div>
                        <div class="form-group">
                            <label for="txtDiachi">Số lượng còn</label>
                            <input type="text" class="form-control" id="txtDiachi" name="txtSoluongcon"
                                placeholder="Nhập số lượng còn">
                        </div>
                        <div class="form-group">
                            <label for="txtSđt">Giá nhập</label>
                            <input type="text" class="form-control" id="txtSđt" name="txtGianhap"
